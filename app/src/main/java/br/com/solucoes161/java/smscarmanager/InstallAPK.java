...
/**
 * Created by Melky on 26/10/2015.
 */
public class InstallAPK extends AsyncTask<String,Void,Void> {
    ...
    protected Void doInBackground(String... arg0) {
        try {
            ...
            File myDir = new File(sdCard+"/smscarmanager/","temp");
            myDir.mkdirs();
            ...
            intent.setDataAndType(Uri.fromFile(new File(myDir + "/temp.apk")), "application/vnd.android.package-archive");
            Log.d("IAPK", Uri.fromFile(new File(myDir + "/temp.apk")).toString());
